...
OWNER_ID = environ.get('OWNER_ID', '852190589')
BOT_TOKEN = environ.get('BOT_TOKEN', "5918038913:AAH1RVmxw872WhtVm3nBe-QzyYwb_-zfYwo")
...
STREAM_API = (environ.get('STREAM_API', '5174613668dc507cfe3b8b80b3c5a1b0f718278c'))
...
CHAT_GROUP = int(environ.get("CHAT_GROUP", "-1001837694049"))
...
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @Super4crazy</b>")
APPROVED = environ.get("APPROVED_WELCOME", "on").lower()

# Referal Settings
REFERAL_COUNT = int(environ.get('REFERAL_COUNT', '20')) # number of referal count
REFERAL_PREMEIUM_TIME = environ.get('REFERAL_PREMEIUM_TIME', '1 week')
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Super4crazy') # owner username without @

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002116984433')) #Log channel id ( make sure bot is admin )
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1002116984433'))

# Verify
VERIFY = bool(environ.get('VERIFY', True)) # Verification On ( True ) / Off ( False )
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/c/1940695233/4') # How to open tutorial link for verification
...
BOT_ID = environ.get("BOT_ID", "852190589")
S_GROUP = environ.get('S_GROUP', "MdiskGroup")
S_CHANNEL = environ.get('S_CHANNEL', "Super4crazy")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/MdiskGroup') #Support group link ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002116984433'))
